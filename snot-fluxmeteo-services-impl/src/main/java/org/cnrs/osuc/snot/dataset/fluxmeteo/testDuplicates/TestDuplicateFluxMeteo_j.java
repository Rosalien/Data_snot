 ...
 */
public class TestDuplicateFluxMeteo_j extends AbstractTestDuplicate {
     ...
     *
     */
    public static final String PROPERTY_MSG_DOUBLON_LINE_J = "PROPERTY_MSG_DOUBLON_LINE_J";
    /**
     ...
     */
    public TestDuplicateFluxMeteo_j() {
    ...
    protected void addLine(final String date, final long lineNumber) {
        ...
        if (!this.line.containsKey(key)) {
            ...
            this.errorsReport.addErrorMessage(String.format(SNOTRecorder.getSnotMessageWithBundle(TestDuplicateFluxMeteo_j.SNOT_DATASET_FLUXMETEO_BUNDLE_NAME, TestDuplicateFluxMeteo_j.PROPERTY_MSG_DOUBLON_LINE_J), lineNumber, date, this.line.get(key).first().intValue()));
        }
