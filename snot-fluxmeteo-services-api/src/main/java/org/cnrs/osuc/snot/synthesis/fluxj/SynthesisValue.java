 ...
 * @author ptcherniati
 */
@Entity(name = "FluxjSynthesisValue")
@Table(name = "FluxjSynthesisValue", 
       indexes = {
           @Index(name = "FluxjSynthesisValue_site_variable_idx", columnList = "site,variable"),
           @Index(name = "FluxjSynthesisValue_site_idx", columnList = "site")
       })
