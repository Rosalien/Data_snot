 ...
 * 
 */
@Entity(name = "FluxmSynthesisValue")
@javax.persistence.Table(name = "FluxmSynthesisValue", 
       indexes = {
           @javax.persistence.Index(name = "FluxmSynthesisValue_site_variable_idx", columnList = "site,variable"),
           @javax.persistence.Index(name = "FluxmSynthesisValue_site_idx", columnList = "site")
       })
