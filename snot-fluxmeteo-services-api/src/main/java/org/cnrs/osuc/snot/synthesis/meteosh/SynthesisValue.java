 ...
 * 
 */
@Entity(name = "MeteoshSynthesisValue")
@javax.persistence.Table(name = "MeteoshSynthesisValue", 
       indexes = {
           @javax.persistence.Index(name = "MeteoshSynthesisValue_site_variable_idx", columnList = "site,variable"),
           @javax.persistence.Index(name = "MeteoshSynthesisValue_site_idx", columnList = "site")
       })
